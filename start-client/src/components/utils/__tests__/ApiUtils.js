...
describe('getShareUrl', () => {
  it('return the base URL with custom values', () => {
    ...
    expect(result).toBe(
      'type=foo1&language=foo2&platformVersion=foo3&packaging=foo4&jvmVersion=foo5&groupId=foo6&artifactId=foo7&name=foo8&description=foo9&packageName=foo10&run=true&dependencies=foo11,foo12'
    )
  })
})
