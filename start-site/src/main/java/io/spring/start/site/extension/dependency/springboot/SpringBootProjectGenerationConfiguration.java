...
import io.spring.start.site.extension.dependency.casslog.CasslogMavenBuildCustomezer;
...
public class SpringBootProjectGenerationConfiguration {
    ...
    @Bean
    @ConditionalOnRequestedDependency("casslog")
    @ConditionalOnBuildSystem(MavenBuildSystem.ID)
    public CasslogMavenBuildCustomezer casslogMavenBuildCustomezer() {
        return new CasslogMavenBuildCustomezer();
    }
